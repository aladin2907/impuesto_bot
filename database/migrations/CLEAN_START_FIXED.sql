-- ============================================================
-- ПОЛНЫЙ СБРОС БАЗЫ ЗНАНИЙ (сохраняет таблицы пользователей!)
-- ⚠️ ОСТОРОЖНО: Удаляет все таблицы базы знаний!
-- ============================================================

-- ============================================================
-- ШАГ 1: Удаляем только таблицы базы знаний
-- НЕ трогаем: users, dialogue_sessions, user_tax_profile, messages
-- ============================================================
...
-- ============================================================
-- ШАГ 3: Создаем таблицы базы знаний с векторами
-- ============================================================
