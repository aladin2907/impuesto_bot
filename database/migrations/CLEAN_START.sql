...
-- ⚠️ ОСТОРОЖНО: Удаляет ВСЕ старые таблицы и данные!
-- ============================================================

-- ============================================================
-- ШАГ 1: Удаляем ВСЕ старые таблицы
-- ============================================================
...
-- Таблица sent_reminders если есть
DROP TABLE IF EXISTS sent_reminders CASCADE;

RAISE NOTICE '✅ Все старые таблицы удалены';
...
RAISE NOTICE '✅ Расширения включены (UUID, pgvector)';

-- ============================================================
-- ШАГ 3: Создаем таблицы с нуля
-- ============================================================
...
RAISE NOTICE '✅ Создана таблица: telegram_threads_content';
...
RAISE NOTICE '✅ Создана таблица: pdf_documents_content';
...
RAISE NOTICE '✅ Создана таблица: news_articles_content';

-- 4. calendar_deadlines
...
COMMENT ON TABLE calendar_deadlines IS 'Налоговые дедлайны (только Full-Text Search, без векторов)';

RAISE NOTICE '✅ Создана таблица: calendar_deadlines';

-- ============================================================
-- ШАГ 4: Функции гибридного поиска
-- ============================================================
...
RAISE NOTICE '✅ Созданы функции гибридного поиска';
...
RAISE NOTICE '✅ Созданы триггеры автообновления';
...
RAISE NOTICE '✅ Создано представление статистики';
...
RAISE NOTICE '🎉 База данных полностью пересоздана!';
RAISE NOTICE '✅ 4 таблицы';
RAISE NOTICE '✅ 2 функции гибридного поиска';
RAISE NOTICE '✅ 4 триггера';
RAISE NOTICE '✅ 1 представление';
RAISE NOTICE '📊 Используйте: SELECT * FROM v_vector_store_stats;';
